var deutscheDemo = angular
		.module('BatDemo', [ 'ngResource', 'ngCookies', 'ngRoute', 'Page0Ctrl',
				'Page1Ctrl', 'Page2Ctrl', 'Page3Ctrl', 'Page4Ctrl',
				'Page5Ctrl', 'ScenarioCtrl', 'finalizeCtrl', 'IndexCtrl' ]);
				...
				[
						...
						function($scope, $http, $resource, $location,
							...
							$scope.login = function() {
								 ...
								 * "/api/LoginCheck", header: { 'Content-Type':
								 * "application/json",
								 ...
								 * $scope.password); userid=$scope.username;
								 * $location.path('/globaltransfer'); }else {
								 * alert("Invalid Username/Password. Please try
								 * again."); $location.path('/login'); }
								 * }).error(function(error) { alert("Network
								 * Connection failed"); });
								 */
								// To Bypass Login
								$rootScope.dashboard = false;
								if (($scope.username === "nextgen" && $scope.password === "nextgen")
										|| ($scope.username === "bobm" && $scope.password === "bobm")) {
...
deutscheDemo.factory('AuthenticationService', [ 'Base64', '$cookieStore',
		'$rootScope', function(Base64, $cookieStore, $rootScope) {
			var service = {};
